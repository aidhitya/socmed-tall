    ...
    <div class="mt-1">
        <form wire:submit.prevent="edit">
            <div class="mb-2">
                ...
                <input id="name" type="text" class="w-full border-gray-300 rounded" wire:model="name">
            </div>
            <div class="mb-5">
                <label for="picture" class="block mb-1 font-medium capitalize">profile picture</label>
                <input id="picture" type="file" class="w-full border-gray-300 rounded" wire:model="picture">
            </div>
            <div class="mb-2">
                <label for="username" class="block mb-1 font-medium">Username</label>
                <input id="username" type="text" class="w-full border-gray-300 rounded" wire:model="username">
            </div>
            <div class="mt-5">
