<div class="fixed top-0 left-0 flex items-center w-full h-full bg-gray-500 bg-opacity-50">
    <x-modal class="left-0 px-20 bg-white border border-red-500">
        ...
        <p class="text-4xl font-semibold text-center text-black">Are You Sure ?</p>
